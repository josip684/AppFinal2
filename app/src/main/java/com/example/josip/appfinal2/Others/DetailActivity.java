...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // pozivamo funkciju dolje implementiranu
        setUpUIViews();
        ...
        if(bundle != null){
            ...
            btnCheckAD.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(etAD.getText().toString().toLowerCase().equals(theoryModel.getCorrectAnswer().toLowerCase()))
                    {
            ...
            btnNextAD.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(DetailActivity.this,BasicConceptsActivity.class);
